  ...
  const items = [
    {
      ...
      content:
        'Originally I was planning to write in pure REACT/REDUX with Server Side Rendering. Now the entire typeMuse system is being written in NEXT.js with TypeScript, Tailwind CSS and Style Components.',
    },
    {
      id: '89jek2jksok',
